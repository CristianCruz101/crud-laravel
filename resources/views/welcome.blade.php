...
<div class="row">
    <div class="card text-bg-dark mb-3">
        ...
        {{-- <hr class="border border-light border-3 opacity-100"> --}}
        <div class="card-body ">
            <div class="row">
                <div class="col-sm-12">
          ...
          <hr class="border border-light border-2 opacity-100">
            ...
            <a name="" id="" class="btn btn-primary" href="{{route("personas.create")}}" role="button">
            ...
            <table class="table table-sm table-bordered table-dark table-hover border-3 border-light">
                ...
                <tbody>
                    @foreach ($datos as $items)
                        <tr>
                            <td><a name="" id="" class="btn btn-danger" href="{{route("personas.show")}}" role="button"> <i class="bi bi-person-x"></i> Eliminar</a></td>
                            <td><a name="" id="" class="btn btn-primary" href="{{route("personas.edit")}}" role="button"> <i class="bi bi-pencil-square"></i>Editar</a></td>
                            <td>{{$items->created_at}}</td>
                            <td>{{$items->usu_email}}</td>
                            <td>{{$items->usu_telefono}}</td>
                            <td>{{$items->usu_nombre}}</td>
                            <td>{{$items->usu_id}}</td>
                            <td>
                                {{-- <form action="{{route("personas.edit", $item->usu_id)}}" method="GET"></form> --}}
                            </td>
                        </tr>
                    @endforeach
                </tbody>
